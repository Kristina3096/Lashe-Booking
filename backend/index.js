...
const app = express();
const port = process.env.PORT || 3001; // Ky është rregullimi i duhur për Render
...
app.listen(port, () => {
  console.log(`Server running on port ${port}`); // Ky do të jetë porti i duhur që Render cakton.
});
